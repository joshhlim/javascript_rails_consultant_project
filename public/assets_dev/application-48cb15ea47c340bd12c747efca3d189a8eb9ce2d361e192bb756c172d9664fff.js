...
jQuery(document).ready(function () {
        $('select[data-option-dependent=true]').each(function (i) {
            ...
            // Grab variables from the data passed in
            ...
            var prompt_text = $(this).data('option-prompt-text');
            var prompt_text = prompt_text ? prompt_text : 'Select';


            var prompt = $(this).has('option[value]').size() ? $(this).find('option[value]') : $('<option value=\"\">').text(prompt_text);
...
(function() {
  $(function() {
    $("a#maintenance-log-link").click(function() {
...
$(document).on("turbolinks:load", function() {
  $(".vehicle-info").on("submit", "form.mileage-update-form", function(event){
    event.preventDefault();
  })
})
;
