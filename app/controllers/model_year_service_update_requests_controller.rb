class ModelYearServiceUpdateRequestsController < ApplicationController
  
    def create
      @request = ModelYearServiceUpdateRequest.new(vote_params)
      if signed_in?
    ...
    private
      ...
      def vote_params
        params.permit(:model_year_service_id)
      end
end
