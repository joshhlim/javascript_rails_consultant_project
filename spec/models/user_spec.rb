...
describe User do
  ...
  # Instantiate a user to use for testing
  before do
    @user = User.new(name: "Example User", email: "user@example.com",
                     password: "foobar", password_confirmation: "foobar")
  end

  # Make the instantiated object the "subject" of the tests
  subject { @user }

  # Test that @user responds to everything that we want it to
  ...
  # Remember token tests - END

  # Micropost tests - START
  ...
  describe "micropost associations" do
    ...
    describe "status" do
      ...
      # RSpec is checking that an array includes the given object
    ...
    # Password reset tests - START

    describe "forgotten password" do
      before { @user.send_password_reset }

      it { expect(@user.password_reset_token).to_not be_blank }
      it { expect(@user.password_reset_sent_at).to_not be_blank }
    end


    # Password reset tests - END
